...
const MAX_BLOCKS_X = 20;
const MAX_BLOCKS_Y = 10;
const MAX_BLOCKS_Z = 10;

const double BLOCK_SIDE = 1;
  ...
  // now we find the intersection of each vertex with the vision plane
      for(k1= 0; k1 < MAX_BLOCKS_X; k1++){
         ...
         angle = acos(cosine);
          ...
          _blocks[k1][k2][k3]._2vertices[v].distance_vertex_intersection = distance_vertex_intersection;
          _blocks[k1][k2][k3]._2vertices[v].distance_camera_intersection = distance_camera_intersection;
          _blocks[k1][k2][k3]._2vertices[v].distance_vertex_camera = distance_vertex_camera;
          _blocks[k1][k2][k3]._2vertices[v].angle = angle;
        }
        ...
        within_bounds = true;
          ...
          if(
          	( distance_vertex_camera < _blocks[k1][k2][k3]._2vertices[0].distance_camera_intersection)
            	|| ( _blocks[k1][k2][k3]._2vertices[0].distance_vertex_intersection > MAX_VIEWING_DISTANCE)
            	|| ( fabs(_blocks[k1][k2][k3]._2vertices[0].angle) > M_PI/2.0)
             ||
            ( distance_vertex_camera < _blocks[k1][k2][k3]._2vertices[1].distance_camera_intersection)
            	|| ( _blocks[k1][k2][k3]._2vertices[1].distance_vertex_intersection > MAX_VIEWING_DISTANCE)
            	|| ( fabs(_blocks[k1][k2][k3]._2vertices[1].angle) > M_PI/2.0)
             ||
            ( distance_vertex_camera < _blocks[k1][k2][k3]._2vertices[2].distance_camera_intersection)
            	|| ( _blocks[k1][k2][k3]._2vertices[2].distance_vertex_intersection > MAX_VIEWING_DISTANCE)
            	|| ( fabs(_blocks[k1][k2][k3]._2vertices[2].angle) > M_PI/2.0)
             ||
            ( distance_vertex_camera < _blocks[k1][k2][k3]._2vertices[3].distance_camera_intersection)
            	|| ( _blocks[k1][k2][k3]._2vertices[3].distance_vertex_intersection > MAX_VIEWING_DISTANCE)
            	|| ( fabs(_blocks[k1][k2][k3]._2vertices[3].angle) > M_PI/2.0)
             ||
            ( distance_vertex_camera < _blocks[k1][k2][k3]._2vertices[4].distance_camera_intersection)
            	|| ( _blocks[k1][k2][k3]._2vertices[4].distance_vertex_intersection > MAX_VIEWING_DISTANCE)
            	|| ( fabs(_blocks[k1][k2][k3]._2vertices[4].angle) > M_PI/2.0)
             ||
            ( distance_vertex_camera < _blocks[k1][k2][k3]._2vertices[5].distance_camera_intersection)
            	|| ( _blocks[k1][k2][k3]._2vertices[5].distance_vertex_intersection > MAX_VIEWING_DISTANCE)
            	|| ( fabs(_blocks[k1][k2][k3]._2vertices[5].angle) > M_PI/2.0)
             ||
            ( distance_vertex_camera < _blocks[k1][k2][k3]._2vertices[6].distance_camera_intersection)
            	|| ( _blocks[k1][k2][k3]._2vertices[6].distance_vertex_intersection > MAX_VIEWING_DISTANCE)
            	|| ( fabs(_blocks[k1][k2][k3]._2vertices[6].angle) > M_PI/2.0)
             ||
            ( distance_vertex_camera < _blocks[k1][k2][k3]._2vertices[7].distance_camera_intersection)
            	|| ( _blocks[k1][k2][k3]._2vertices[7].distance_vertex_intersection > MAX_VIEWING_DISTANCE)
            	|| ( fabs(_blocks[k1][k2][k3]._2vertices[7].angle) > M_PI/2.0)
            )
          {
            within_bounds = false;
        ...
        if(within_bounds){
          TPoint points0[4] = {
          	Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[0].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[0].y)),
            Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[1].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[1].y)),
            Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[2].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[2].y)),
            Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[3].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[3].y))
          };
          TPoint points1[4] = {
          	Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[4].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[4].y)),
            Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[5].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[5].y)),
            Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[6].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[6].y)),
            Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[7].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[7].y))
          };
          TPoint points2[4] = {
          	Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[0].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[0].y)),
            Point(screen->Width / 2 + ((screen->Width/2) * _blocks[k1][k2][k3]._2vertices[3].x), screen->Height / 2 - ( (screen->Height/2) * _blocks[k1][k2][k3]._2vertices[3].y)),
          ...
          if(_blocks[k1][k2][k3]._type == typeSOLID)
          {
